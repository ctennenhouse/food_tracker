...
- You can save and delete url/key pairs in the dropdown menu. If using a local llm, replace the API key with your chosen model name to ensure correct functionality from the API request.
